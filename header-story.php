...
<div class="menuBtn-icon">
  ...
  <span class="menuBtn-icon-line03"></span>
   ...
   <div class="wrap-story-intro story-container">    
      <div class="media media-r">
	 			<h1 class="story-title">GT Story</h1>
					<div class="container">
		  				<div class="row">
		      			...
		      			<div class="col col--12-of-12">
											...
											<p class="media--text"><strong>Gary Thomson</strong> grew up among the silver, granite architecture of
							 				Aberdeen, and takes much of 
							 				the inspiration for his fine work in wood, from many of the world renowned buildings 
							 				that flank its main streets.</p>   
